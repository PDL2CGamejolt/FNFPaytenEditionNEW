...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItemsOG:Array<String> = ['Resume', 'Restart Song', 'Change Difficulty', 'End Song', 'Toggle Practice Mode', 'Toggle Botplay', 'Gameplay Changers', 'Options', 'Exit to menu'];
	...
	public function new(x:Float, y:Float)
	{
		...
		var levelDifficulty:FlxText = new FlxText(20, 15 - 99, 0, "", 32);
